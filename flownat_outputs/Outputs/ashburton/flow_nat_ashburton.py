...
from_date = '1974-07-01'
to_date = '2020-06-30'
rec_data_code = 'Primary'
output_path = r'C:\Users\hamishg\OneDrive - Environment Canterbury\Documents\_Projects\git\flownat\71106'
input_sites1 = ['71106']
...
flow_rec = nat_flow['Flow'].rename(columns={71106: '71106'})
malf_rec = malf7d(flow_rec)

flow_nat = nat_flow['NatFlow'].rename(columns={71106: '71106'})
...
allo1.to_csv(os.path.join(output_path, 'above_71106_allo_2021-02-04.csv'), index=False)
use1.to_csv(os.path.join(output_path, 'above_71106_usage_2021-02-04.csv'), index=False)
waps.to_file(os.path.join(output_path, 'above_71106_waps_2021-02-04.shp'))

nat_flow.to_csv(os.path.join(output_path, 'above_71106_flownat_2021-02-04.csv'))

malf_rec.to_csv(os.path.join(output_path, 'above_71106_rec_flow_malf_2021-02-04.csv'))
malf_nat.to_csv(os.path.join(output_path, 'above_71106_nat_flow_malf_2021-02-04.csv'))
