...
from_date = '1964-07-01'
to_date = '2019-06-30'
rec_data_code = 'Primary'
output_path = r'T:\Temp\HamishG'
input_sites1 = ['71103']
...
f1 = FlowNat(from_date, to_date, input_sites=input_sites1, output_path=output_path, catch_del='internal')
...
flow_rec = nat_flow['Flow'].rename(columns={71103: '71103'})
malf_rec = malf7d(flow_rec)

flow_nat = nat_flow['NatFlow'].rename(columns={71103: '71103'})
...
allo1.to_csv(os.path.join(output_path, 'above_stanton_allo_2020-10-05.csv'), index=False)
use1.to_csv(os.path.join(output_path, 'above_stanton_usage_2020-10-05.csv'), index=False)
waps.to_file(os.path.join(output_path, 'above_stanton_waps_2020-10-05.shp'))

nat_flow.to_csv(os.path.join(output_path, 'above_stanton_flow_nat_2020-10-05.csv'))

malf_rec.to_csv(os.path.join(output_path, 'above_stanton_rec_flow_malf_2020-10-05.csv'))
malf_nat.to_csv(os.path.join(output_path, 'above_stanton_nat_flow_malf_2020-10-05.csv'))
